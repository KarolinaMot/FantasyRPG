// GENERATED AUTOMATICALLY FROM 'Assets/SCRIPTS/ControllerInput/PlayerControls.inputactions'
...
public class @PlayerControls : IInputActionCollection, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""PlayerMovement"",
            ""id"": ""7c8a6f8f-ba03-4f4e-b64b-ed94794943e7"",
            ""actions"": [
                {
                    ""name"": ""Movement"",
                    ""type"": ""PassThrough"",
                    ""id"": ""c6041a33-8f54-4496-a570-4dfb12daaef3"",
                ...
                },
                {
                    ""name"": ""Camera"",
                    ""type"": ""PassThrough"",
                    ""id"": ""0c63dd1b-bebd-413c-bf96-17fd6c210df8"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                {
                    ""name"": ""WASD"",
                    ""id"": ""42ce7ec1-09e3-4299-a399-e3049991d47a"",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""dff90eeb-9290-47a5-954d-7709a6a609d8"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""334f454e-1094-4049-875c-4f4b81866c77"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""60483af7-f9d5-4f9c-b74b-0536753dca2c"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""57d550be-3322-4f9b-850c-7ca9ecf773fa"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""Left Stick"",
                    ""id"": ""6737da55-bff2-42c3-87af-f7cb74bf0d57"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""cd47b5d0-2e63-4dfd-b6c9-aaa12959770f"",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""2c71a436-de41-4584-9cab-5bffca9e3bb3"",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""7ddcef3f-4dd8-4b2f-9cba-52330944a4eb"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""bdd5714c-f5aa-4d35-b721-f9f520718dcc"",
                ...
                {
                    ""name"": """",
                    ""id"": ""835e2e9a-0513-4f0e-9f62-e53d110fc16d"",
                    ""path"": ""<Mouse>/delta"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""Right Stick"",
                    ""id"": ""6f0221fe-8392-4f83-a163-1a849d3508c0"",
                    ""path"": ""2DVector(mode=2)"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""17ebe81a-3682-421a-9cf2-424ccfeaa540"",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""0583c37d-ec74-4115-b410-24415342aeda"",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""f5864e3f-299a-4f04-b2b2-47a1a52ca216"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""bfa1f1ca-35a8-4608-acf4-7391522bce8d"",
        ...
        {
            ""name"": ""PlayerActions"",
            ""id"": ""06808289-6ddd-4270-af9b-1162939c6e19"",
            ""actions"": [
                {
                    ""name"": ""Sprint"",
                    ""type"": ""Button"",
                    ""id"": ""4df2c915-50b4-4edb-94c6-e258a159eaed"",
                ...
                },
                {
                    ""name"": ""Jump"",
                    ""type"": ""Button"",
                    ""id"": ""e0cfecd4-1b83-428a-8bb9-08a7e87bfaa0"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""Attack"",
                    ""type"": ""Button"",
                    ""id"": ""2e45630a-6cdb-4259-abc1-6066b662b918"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""2c83656a-f4a4-4e9f-a729-3dab9a0bad39"",
                ...
                {
                    ""name"": """",
                    ""id"": ""63535a0d-aebe-4b8e-ade7-a8cbf997ca7d"",
                ...
                {
                    ""name"": """",
                    ""id"": ""1c19d832-814d-4f2b-800e-7f127e9f15a0"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""5f4e419c-5d2e-4a88-9649-5d11054bf1df"",
                ...
                {
                    ""name"": """",
                    ""id"": ""4829ee37-d373-409f-88f4-c7351d20989d"",
                ...
                {
                    ""name"": """",
                    ""id"": ""52284038-1eaf-4a3b-aaf3-d3dec03a2a67"",
